...
describe('REST', () => {
  ...
  describe('getTransactionByHash()', () => {
    ...
    it('should throw an error if a method contains invalid arguments', async () => {
      try {
        await new Client(config.chavinci).getTransactionByHash('foobar');
    ...
    it('should throw an error if a method in binary mode contains invalid arguments', async () => {
      try {
        await new Client(config.chavinci).getTransactionByHash('foobar', { extension: 'bin' });
  ...
  describe('getBlockchainInformation()', () => {
    it('should return blockchain information json-encoded by default', async () => {
      const information = await new Client(config.chavinci).getBlockchainInformation();
  ...
  describe('getUnspentTransactionOutputs()', () => {
    it('should return unspent transaction outputs json-encoded by default', async () => {
      const result = await new Client(config.chavinci).getUnspentTransactionOutputs([{
    ...
    it('should return unspent transaction outputs binary-encoded if extension is `bin`', async () => {
      ...
      const binaryUnspents = await new Client(config.chavinci).getUnspentTransactionOutputs(outputs, { extension: 'bin' });
      const hexUnspents = await new Client(config.chavinci).getUnspentTransactionOutputs(outputs, { extension: 'hex' });
  ...
  describe('getMemoryPoolInformation()', () => {
    it('should return memory pool information json-encoded by default', async () => {
      const information = await new Client(config.chavinci).getMemoryPoolInformation();
