...
const client = new Client(_.defaults({ version: '0.17.0', wallet: 'wallet1' }, config.chavinciMultiWallet));
...
describe('Multi Wallet', () => {
  ...
  describe('default wallet', () => {
    it('should return the balance for the default wallet with multiple wallets loaded if `allowDefaultWallet` is true', async () => {
      const client = new Client(_.defaults({ allowDefaultWallet: true, version: '0.17.0' }, config.chavinciMultiWallet));
    ...
    it('should fail getting balance for default wallet with `allowDefaultWallet` as `false`', async () => {
      const client = new Client(_.defaults({ version: '0.17.0' }, config.chavinciMultiWallet));
