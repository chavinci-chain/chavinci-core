  ...
  describe('wallet-level requests', () => {
    ...
    describe('getBalance()', () => {
      ...
      it('should support named parameters', async () => {
        const client = new Client(_.defaults({ version: '0.17.0' }, config.chavinci));
    ...
    describe('getNewAddress()', () => {
      it('should return a new chavinci address', async () => {
    ...
    describe('listTransactions()', () => {
      ...
      it('should support named parameters', async () => {
        ...
        let transactions = await new Client(_.defaults({ version: '0.17.0' }, config.chavinci)).listTransactions();

        should(transactions).be.an.Array();
        should(transactions.length).be.greaterThanOrEqual(5);

        // Make sure `count` is read correctly.
        transactions = await new Client(_.defaults({ version: '0.17.0' }, config.chavinci)).listTransactions({ count: 1 });
