...
class Client {
  constructor({
    ...
    headers = false,
    host = 'localhost',
    logger = debugnyan('chavinci-core'),
    network = 'mainnet',
    password,
    port,
    ssl = false,
    ...
    // Version handling.
    if (version) {
      // Capture X.Y.Z when X.Y.Z.A is passed to support oddly formatted Chavinci Core
   ...
   * 	 - https://github.com/chavinci/bips/blob/master/bip-0064.mediawiki
   */
